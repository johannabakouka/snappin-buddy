...
// Floute une position de ~400m aléatoirement
    ...
    import('leaflet').then(async L => {
            ...
            if (isMe) {
              const meIcon = L.divIcon({
                ...
                html: `<div style="display:flex;flex-direction:column;align-items:center;gap:4px;">
                  ...
                  <span style="font-size:10px;font-weight:700;color:white;background:rgba(10,10,10,0.7);padding:1px 6px;border-radius:8px;white-space:nowrap;">Vous</span>
                </div>`,
                iconSize: [44, 60],
                iconAnchor: [22, 22],
              });
              ...
              // Position floutée pour les autres buddies
              ...
              const buddyIcon = L.divIcon({
                ...
                html: `<div style="display:flex;flex-direction:column;align-items:center;gap:4px;cursor:pointer;">
                  <div style="width:44px;height:44px;border-radius:50%;background:#1A1A1A;border:3px solid ${statusColor};display:flex;align-items:center;justify-content:center;font-size:20px;box-shadow:0 2px 8px rgba(0,0,0,0.4);">◉</div>
      ...
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(async pos => {
          ...
          if (user) {
            // Sauvegarde position floutée dans Supabase
    ...
    <div style={{ position: 'relative', height: '100vh' }}>
      ...
      {popupBuddy && (
        <div style={{
          ...
          <div style={{ fontFamily: 'var(--font-nunito)', fontWeight: '900', fontSize: '17px', color: 'white', marginBottom: '2px' }}>
            {popupBuddy.username}
          </div>
          ...
          {popupBuddy.bio && (
            <p style={{
              color: 'rgba(255,255,255,0.6)', fontSize: '12px', fontStyle: 'italic',
